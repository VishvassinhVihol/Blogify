    ...
    return (
        <div className='flex items-center  justify-center py-10   '>
            <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10  border border-black/10`}>
                ...
                <h2 className="text-center md:text-2xl text-xl font-bold leading-tight">Sign in to your account</h2>
...
handleSubmit: ye ek function hota hai jo form submit hone par tumhare diye gaye method ko call karta hai (jaise login method yaha). */}
                <form onSubmit={handleSubmit(login)} validate > {/*Jab user form submit karega, handleSubmit pehle validation karega.
